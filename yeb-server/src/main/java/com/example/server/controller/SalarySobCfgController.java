...
public class SalarySobCfgController {
    ...
    @ApiOperation(value = "获取所有员工套账（分页）")
    @GetMapping("/")
    public RespPageBean getEmployeeWithSalary(@RequestParam(defaultValue = "1") Integer currentPage, @RequestParam(defaultValue = "10") Integer size, String name){
    ...
    @PutMapping("/")
    public RespBean updateEmployeeSalary(Integer eid, Integer sid){  //传员工id和salaty id
